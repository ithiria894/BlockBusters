...
const projectId = "2O0Z0RWE1bAj8oSUTRy9N9pNzTl";
const projectSecretKey = "3cc10dacccb6461dfadf3eadac762a20";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "blockbusters.infura-ipfs.io";
...
export const NFTMarketplaceProvider = ({ children }) => {
  const titleData = "Discover, collect, and sell Game Assets";
  ...
  return (
    <NFTMarketplaceContext.Provider
      value={{ // whatever being passed here is available to all the components!!!!
        checkIfWalletConnected,
        connectWallet,
        uploadToIPFS,
        createNFT,
